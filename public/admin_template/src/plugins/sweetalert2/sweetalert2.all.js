...
(function (global, factory) {
      ...
      Object.keys(defaultInputValidators).forEach(function (key) {
        if (params.input === key) {
          params.inputValidator = params.expectRejections
            ...
            : sweetAlert.adaptInputValidator(defaultInputValidators[key]);
        }
      });
    }
    ...
    return new Promise(function (resolve, reject) {
      ...
      var handleKeyDown = function handleKeyDown(event) {
        ...
        if (e.key === "Enter" && !e.isComposing) {
          ...
          callIfFunction(params.allowEscapeKey) === true
        ) {
   ...
   */
  sweetAlert.close =
    sweetAlert.closePopup =
    sweetAlert.closeModal =
    sweetAlert.closeToast =
      function (onComplete) {
        var container = getContainer();
        var popup = getPopup();
        if (!popup) {
  ...
  if (
    ...
    _typeof$1(window._swalDefaults) === "object"
  ) {

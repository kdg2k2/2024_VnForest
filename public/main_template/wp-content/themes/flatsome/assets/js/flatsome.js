! function(t) {
    ...
    */
    ...
    if (jQuery(".sticky-shrink .header-wrapper").length) {
        ...
        o = -1 - (l += jQuery("#wpadminbar").height()), r = -1 - l
    }
    if (s && (n.find(".header-wrapper").waypoint((function(t) {
        ...
        jQuery(window).scroll((function() {
            ...
            t >= e.outerHeight() && (t <= u ? (e.addClass("stuck"), n.removeClass("sticky-hide-on-scroll--active")) : (e.removeClass("stuck"), n.addClass("sticky-hide-on-scroll--active"))), c = setTimeout((function() {
                u = jQuery(window).scrollTop()
            }), 100)
        }))
    }
}, function(t, e, i) {
    ...
    jQuery(".section .loading-spin, .banner .loading-spin, .page-loader").fadeOut(), jQuery("#top-link").click((function(t) {
        ...
        e && setTimeout((function() {
            ...
            t.hasClass("menu-item-has-block has-dropdown") && !t.hasClass("current-dropdown") && jQuery("#menu-item-".concat(e, " a:first")).click()
        }), 1e3)
    ...
    Flatsome.behavior("tabs", {
        attach: function(t) {
            ...
            jQuery(".tabbed-content", t).each((function(t, o) {
                ...
                })), l.length && (e.toLowerCase().indexOf("comment-") >= 0 || "#comments" === e || "#reviews" === e || "#tab-reviews" === e || n.indexOf("comment-page-") > 0 || n.indexOf("cpage=") > 0) && (l.find("a").click(), jQuery.scrollTo(".reviews_tab", {
                    duration: 300,
                    offset: -150
                }))
            }))
...
function printPage() {
    ...
    newWin = window.open("");
    newWin.document.write("<h3 align='center'>In</h3>");

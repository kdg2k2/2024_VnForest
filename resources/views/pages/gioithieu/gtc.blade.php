                  ...
                  <header class="entry-header">
                    <div class="entry-header-text entry-header-text-top text-left">
                      {{-- <h6 class="entry-category is-xsmall">
                        <a href="https://vnforest1.xuanmaijsc.vn/category/menu-tin-tuc-su-kien/tin-tong-cuc-lam-nghiep/" rel="category tag">Tin Tổng Cục Lâm nghiệp</a>
                      </h6> --}}
                      <h1 class="entry-title">{{ $data->tieude }}</h1>
                      <div class="entry-divider is-divider small"></div>
                      {{-- <div class="entry-meta uppercase is-xsmall">
                        <span class="posted-on">Posted on <a href="https://vnforest1.xuanmaijsc.vn/2024/01/23/hop-hoi-dong-quan-ly-quy-bao-ve-va-phat-trien-rung-viet-nam-lan-1-nam-2024/" rel="bookmark">
                            <time class="entry-date published updated" datetime="2024-01-23T17:22:10+07:00">23/01/2024</time>
                          </a>
                        </span>

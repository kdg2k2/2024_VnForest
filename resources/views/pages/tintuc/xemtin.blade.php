...
<body
  class="post-template-default single single-post postid-889 single-format-standard _masterslider _ms_version_3.9.5 header-shadow lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border mobile-submenu-slide mobile-submenu-slide-levels-1 mobile-submenu-toggle">
      ...
      <div id="content" class="blog-wrapper blog-single page-wrapper">
        <div class="row row-large row-divided ">
          <div class="large-9 col">
            <article id="post-889"
              class="post-889 post type-post status-publish format-standard has-post-thumbnail hentry category-tin-tong-cuc-lam-nghiep">
              <div class="article-inner ">
                <header class="entry-header">
                  <div class="entry-header-text entry-header-text-top text-left">
                    <h6 class="entry-category is-xsmall">
                      <a href="#" rel="category tag">{{ $data->loaitt->tenloaitt }}</a>
                    </h6>
                    <h1 class="entry-title">{{ $data->tentt }}</h1>
                    <div class="entry-divider is-divider small"></div>
                    <div class="entry-meta uppercase is-xsmall">
                      <span class="posted-on">Thời gian đăng tải <a href="" rel="bookmark">
                          <time class="entry-date published updated">{{ $data->created_at }}</time>
                        </a>
                      </span>
                ...
                <div class="entry-content single-page">
                  ...
                  <div class="blog-share text-center">
                    ...
                    <div class="social-icons share-icons share-row relative">
                      ...
                      <a href="//twitter.com/share?url=https://vnforest1.xuanmaijsc.vn/2024/01/23/hop-hoi-dong-quan-ly-quy-bao-ve-va-phat-trien-rung-viet-nam-lan-1-nam-2024/"
                        onclick="window.open(this.href,this.title,'width=500,height=500,top=300px,left=300px');  return false;"
                        rel="noopener noreferrer nofollow" target="_blank"
                        class="icon button circle is-outline tooltip twitter" title="Share on Twitter">
                        <i class="icon-twitter"></i>
                      </a>
                      <a href="mailto:enteryour@addresshere.com?subject=H%E1%BB%8Dp%20h%E1%BB%99i%20%C4%91%E1%BB%93ng%20qu%E1%BA%A3n%20l%C3%BD%20Qu%E1%BB%B9%20B%E1%BA%A3o%20v%E1%BB%87%20v%C3%A0%20ph%C3%A1t%20tri%E1%BB%83n%20r%E1%BB%ABng%20Vi%E1%BB%87t%20Nam%20l%E1%BA%A7n%201%20n%C4%83m%202024&amp;body=Check%20this%20out:%20https://vnforest1.xuanmaijsc.vn/2024/01/23/hop-hoi-dong-quan-ly-quy-bao-ve-va-phat-trien-rung-viet-nam-lan-1-nam-2024/"
                        rel="nofollow" class="icon button circle is-outline tooltip email" title="Email to a Friend">
                  ...
                  <div class="flex-row next-prev-nav bt bb">
                    <div class="flex-col flex-grow nav-prev text-left">
                      <div class="nav-previous">
                        <a href="https://vnforest1.xuanmaijsc.vn/2024/01/23/vuon-quoc-gia-cuc-phuong-lan-thu-5-lien-tiep-duoc-vinh-danh-la-vuon-quoc-gia-hang-dau-chau-a/"
                          rel="prev">
                          <span class="hide-for-small">
                            <i class="icon-angle-left"></i>
                          </span> Vườn quốc gia Cúc Phương lần thứ 5 liên tiếp được vinh danh là Vườn quốc gia hàng đầu
                          Châu Á </a>
                      </div>
                    </div>
                    <div class="flex-col flex-grow nav-next text-right">
                      <div class="nav-next">
                        <a href="https://vnforest1.xuanmaijsc.vn/2024/01/23/tuyen-quang-tiep-tuc-phat-trien-rung-gan-voi-phat-trien-kinh-te-lam-nghiep-ben-vung/"
                          rel="next">Tuyên Quang tiếp tục phát triển rừng gắn với phát triển kinh tế lâm nghiệp bền vững
                          <span class="hide-for-small">
          ...
          <div class="post-sidebar large-3 col">
            <div id="secondary" class="widget-area " role="complementary">
              <aside id="block-13" class="widget widget_block">
                ...
                <div
                  class="row sidebar-post large-columns-1 medium-columns-1 small-columns-1 has-shadow row-box-shadow-1">
                  <div class="col post-item">
                    <div class="col-inner">
                      <a href="https://vnforest1.xuanmaijsc.vn/2024/01/26/gioi-thieu-chung-ve-cuc-lam-nghiep/"
                        class="plain">
                  ...
                  <div class="col post-item">
                    <div class="col-inner">
                      <a href="https://vnforest1.xuanmaijsc.vn/2024/01/25/tai-lieu-hoi-thao-quoc-gia-ve-nghi-dinh-sua-doi-bo-sung-nghi-dinh-156-2015-nd-cp-nay-24-10-2022/"
                        class="plain">
                        <div class="box box-vertical box-text-bottom box-blog-post has-hover">
                          <div class="box-text text-center is-small" style="padding:0px 5px 0px 5px;">
                            <div class="box-text-inner blog-post-inner">
                              <h5 class="post-title is-large ">Tài liệu Hội thảo quốc gia về Nghị định sửa đổi, bổ sung
                                Nghị định 156/2015/NĐ-CP này 24/10/2022</h5>
                  ...
                  <div class="col post-item">
                    <div class="col-inner">
                      <a href="https://vnforest1.xuanmaijsc.vn/2024/01/25/huong-dan-quan-ly-khu-bao-ton-thien-nhien/"
                        class="plain">
                        <div class="box box-vertical box-text-bottom box-blog-post has-hover">
                          <div class="box-text text-center is-small" style="padding:0px 5px 0px 5px;">
                            <div class="box-text-inner blog-post-inner">
                ...
                <div class="is-divider divider clearfix"
                  style="margin-top:1.5em;margin-bottom:1.5em;max-width:0px;height:0px;"></div>
                <div class="container section-title-container">
                  <h3 class="section-title section-title-center">
                    <b></b>
                ...
                <div class="ux-menu stack stack-col justify-start ux-menu--divider-solid">
                  <div class="ux-menu-link flex menu-item label-popular">
                    <a class="ux-menu-link__link flex" href="https://vpdt.cuclamnghiep.gov.vn/" target="_blank"
                  ...
                  <div class="ux-menu-link flex menu-item label-popular">
                    <a class="ux-menu-link__link flex" href="https://dichvucong.gov.vn/p/home/dvc-tthc-trang-chu.html"

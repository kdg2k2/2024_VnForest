<!-- Basic Page Info -->
<meta charset="utf-8" />
<title>VNFOREST - Trang Quản Trị</title>
...
<link rel="stylesheet" type="text/css"
    href="{{ asset('/admin_template/src/plugins/datatables/css/dataTables.bootstrap4.min.css') }}" />
<link rel="stylesheet" type="text/css"
    href="{{ asset('/admin_template/src/plugins/datatables/css/responsive.bootstrap4.min.css') }}" />

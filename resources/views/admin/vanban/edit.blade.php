        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                    <form class="post-form" method="POST" action="/admin/vanban/update/{{ $data->id }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tenvb" value="{{ $data->tenvb }}" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="sohieu">Số Hiệu</label>
                                    <input type="text" class="form-control" name="sohieu" value="{{ $data->sohieu }}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="donviphathanh" value="{{ $data->donviphathanh }}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="path">Chọn file văn bản (.doc, .docx, .pdf, .zip, .rar)</label>
                                    <input type="file" class="form-control" name="path" value="" accept=".doc, .docx, .pdf, .zip, .rar">
                                </div>
                            </div>

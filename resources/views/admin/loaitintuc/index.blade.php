        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Loại Tin Tức</h4>
                        <div class="btn-create">
                            <a class="btn btn-sm btn-success" href="/admin/loaitt/create"><i
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item" href="/admin/loaitt/edit/{{ $item->id }}"><i
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            btn_delete_item.onclick = function () {
                deleteForm.action = "/admin/loaitt/delete/"+id;
                deleteForm.submit();
            }
        });
    </script>
